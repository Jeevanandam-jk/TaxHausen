...
namespace ReportService.API.Extension;

/// <summary>
/// Provides extension methods for registering application services
/// required by the Report Service.
/// </summary>
public static class ServiceExtension
{
    /// <summary>
    /// Registers the shared logging services for the Report Service.
    /// </summary>
    /// <param name="builder">
    ...
    {
        services.AddSharedLogger(builder.Configuration, "ReportService");
    }
}