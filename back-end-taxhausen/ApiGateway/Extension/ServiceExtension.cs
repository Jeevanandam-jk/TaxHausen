...
/// required by the ApiGateway Service.
/// </summary>
public static class ServiceExtension
{
    /// <summary>
    /// Registers the shared logging services for the ApiGateway Service.
    /// </summary>
    /// <param name="builder">
    ...
    {
        services.AddSharedLogger(builder.Configuration, "ApiGatewayService");
    }
}